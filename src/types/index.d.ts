// Type definitions for dexels-ui-kit 2.1.2
...
export function getAlignment(alignment: Alignments, alignText?: boolean): string;
...
export function hexToRgb(hex: string, transparency?: number): object;
