...
export const tableColumns: (data: TableData[]) => Column<TableData>[] = (data) =>
    useMemo(
        () => [
            ...
            {
                Cell: (row: CellProps<TableData>): ReactNode =>
                    renderStatusCell(row.cell.row.original.matchTaskStatus, row.cell.value),
                accessor: 'status',
                disableSortBy: true,
            ...
            {
                Cell: (row: CellProps<TableData>): ReactNode => renderCell(row),
                Header: 'First Name',
                accessor: 'firstName',
            ...
            {
                Cell: (row: CellProps<TableData>): ReactNode => renderButton(row),
                Header: 'Action',
                accessor: 'action',
                disableSortBy: true,
